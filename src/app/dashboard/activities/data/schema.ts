...
export function getActionBadgeColor(action: ActivityAction): string {
  const createActions = ['BOOK_CREATED', 'AUTHOR_CREATED', 'CATEGORY_CREATED', 'PUBLICATION_CREATED', 'SERIES_CREATED', 'TRANSLATOR_CREATED', 'SELL_POST_CREATED', 'OFFER_CREATED', 'MESSAGE_SENT', 'NOTICE_CREATED', 'BOOKSHELF_CREATED', 'REVIEW_POSTED', 'QUIZ_ATTEMPTED']
  const updateActions = ['BOOK_UPDATED', 'AUTHOR_UPDATED', 'CATEGORY_UPDATED', 'PUBLICATION_UPDATED', 'SERIES_UPDATED', 'TRANSLATOR_UPDATED', 'SELL_POST_UPDATED', 'NOTICE_UPDATED', 'PROFILE_UPDATED', 'READING_PROGRESS_UPDATED']
  const deleteActions = ['BOOK_DELETED', 'AUTHOR_DELETED', 'CATEGORY_DELETED', 'PUBLICATION_DELETED', 'SERIES_DELETED', 'TRANSLATOR_DELETED', 'SELL_POST_DELETED']
