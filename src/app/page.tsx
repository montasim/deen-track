          ...
          <div className="grid md:grid-cols-3 gap-8">
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  {/* Step Number */}
                  <div className="absolute -top-4 -left-4 w-12 h-12 rounded-full bg-gradient-to-br from-neutral-800 to-neutral-900 border-2 border-white/10 flex items-center justify-center text-xl font-black text-neutral-600">
                    {index + 1}
                  </div>
